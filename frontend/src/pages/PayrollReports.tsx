...
export const PayrollReports: React.FC = () => {
  ...
  const handleExportExcel = () => {
    ...
    reportService.exportToXLSX(`Central_Dispatch_Payroll_Report_${new Date().toISOString().slice(0, 10)}.xlsx`, headers, rows, 'Payroll Report');
    showToast('Current payroll report exported to Excel.', 'success');
  };
