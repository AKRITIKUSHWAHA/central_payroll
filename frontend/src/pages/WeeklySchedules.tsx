  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      <div className="bg-white border border-[#dde7f0] rounded-2xl shadow-sm overflow-hidden">
        {/* Schedule Toolbar */}
        <div className="p-4 sm:p-5 border-b border-[#e2e8f0] flex flex-col sm:flex-row items-stretch sm:items-end justify-between gap-4">
        ...
        {/* Schedule Table */}
        <div className="table-responsive-container p-2 sm:p-5">
          <table className="w-full text-left text-sm border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-[#102a43] text-white font-bold text-xs uppercase tracking-wider">
                <th className="py-3 px-4 font-bold min-w-[200px]">Names</th>
                {!scheduleDates.length ? (
                  <th colSpan={8} className="py-3 px-4 font-bold text-left">Choose a week start date</th>
                ) : (
                  <>
                    {scheduleDates.map(d => (
        ...
        <div className="px-4 sm:px-5 pb-5 flex items-center gap-3">
          <button
      ...
      <div className="bg-white border border-[#dde7f0] rounded-2xl shadow-sm overflow-hidden p-5 sm:p-6 space-y-4">
        <div>
