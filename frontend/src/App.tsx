...
// Guard for Super Admin only routes (Dashboard, Employees & Pay Rates, Payroll, Reports, Payslips, User Accounts, Permissions)
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="employees" element={<SuperAdminRoute><Employees /></SuperAdminRoute>} />
              <Route path="employees/:id" element={<SuperAdminRoute><EmployeeProfile /></SuperAdminRoute>} />

              {/* Operations & Workspace Routes (Super Admin & Admin) */}
